...
func NewStoreUseCase(db *gorm.DB, log *logrus.Logger, validate *validator.Validate, storeRepo *repository.StoreRepository, uuid *helper.UUIDHelper) interfaces.StoreUseCase {
	return &StoreUseCase{
		db: db,
		log: log,
		val: validate,
